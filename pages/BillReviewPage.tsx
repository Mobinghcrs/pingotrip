        ...
        <div className="bg-slate-50 min-h-screen">
            ...
            <main className="p-4 pb-28 space-y-6">
                <div className="bg-white rounded-2xl shadow-md border p-4">
                    <h2 className="text-lg font-bold text-slate-800 mb-3 text-center">{t('billDetails')}</h2>
            ...
            <footer className="fixed bottom-0 w-full max-w-md left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-md border-t p-3">
                <div className="flex justify-between items-center px-1 mb-2">
                    ...
                    <span className="text-xl font-bold text-sky-900">{localizeDigits(selectedBill.amount.toLocaleString(language === 'en' ? 'en-US' : 'fa-IR'))} {t('rial')}</span>
                </div>
