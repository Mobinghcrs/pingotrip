...
import { MOCK_DOMESTIC_FLIGHT_BOOKINGS } from '../../constants';
...
const DomesticFlightsAdminPage = () => {
    const { t, localizeDigits } = useTranslation();
    const [bookings, setBookings] = useState<AranBooking[]>(MOCK_DOMESTIC_FLIGHT_BOOKINGS);
    ...
    return (
        <div className="relative min-h-screen bg-slate-100 dark:bg-slate-900">
            <AdminSidebar 
                ...
                activeTab="domestic-flights-admin"
            />
            <div className="md:mr-64 transition-all duration-300">
                <AdminHeader onMenuClick={() => setIsSidebarOpen(true)} />
                <main className="p-4 sm:p-6 lg:p-8">
                    <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-6">{t('domesticFlightsAdmin')}</h2>
...
export default DomesticFlightsAdminPage;