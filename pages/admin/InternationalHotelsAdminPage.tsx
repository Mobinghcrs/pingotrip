...
import { MOCK_INTERNATIONAL_HOTEL_BOOKINGS } from '../../constants';
import { AdminHotelBooking } from '../../types';
import AdminSidebar from '../../components/admin/AdminSidebar';
import AdminHeader from '../../components/admin/AdminHeader';
import {
    SearchIcon, CalendarIcon, EditIcon, FileTextIcon, NavigationIcon, UsersIcon
} from '../../assets/icons';
import HotelBookingDetailsModal from '../../components/admin/HotelBookingDetailsModal';

const InternationalHotelsAdminPage = () => {
    const { t, localizeDigits } = useTranslation();
    const [bookings, setBookings] = useState<AdminHotelBooking[]>(MOCK_INTERNATIONAL_HOTEL_BOOKINGS);
    ...
    return (
        <div className="relative min-h-screen bg-slate-100 dark:bg-slate-900">
            <AdminSidebar
                ...
                activeTab="international-hotels-admin"
            />
            <div className="md:mr-64 transition-all duration-300">
                <AdminHeader onMenuClick={() => setIsSidebarOpen(true)} />
                <main className="p-4 sm:p-6 lg:p-8">
                    <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-6">{t('internationalHotelsAdmin')}</h2>
...
export default InternationalHotelsAdminPage;